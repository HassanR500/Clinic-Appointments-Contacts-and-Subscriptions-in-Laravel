...
<div class="page-content bg-white">
		...
		<!-- Main Banner -->
		<div class="main-banner" style="background-image:url(frontend/images/main-banner/doctor.bg1.jpg);">
				...
				<div class="row align-items-center">
					...
					<div class="col-lg-5 col-md-6 col-sm-5">
						<div class="banner-img">
							<img src="{{asset('frontend/images/main-banner/doctor2.png')}}" alt="">
						</div>
					</div>
				</div>
			</div>
			<img class="pt-img1 animate1" src="{{asset('frontend/images/shap/trangle-orange.png')}}" alt="">
			<img class="pt-img2 animate2" src="{{asset('frontend/images/shap/square-blue.png')}}" alt="">
			<img class="pt-img3 animate3" src="{{asset('frontend/images/shap/chicle-blue-2.png')}}" alt="">
			<img class="pt-img4 animate4" src="{{asset('frontend/images/shap/plus-orange.png')}}" alt="">
			<img class="pt-img5 animate-wave" src="{{asset('frontend/images/shap/wave-orange.png')}}" alt="">
		</div>
		...
		<section class="section-sp1 about-area">
				...
				<div class="row align-items-center">
					<div class="col-lg-6 mb-30">
						<div class="about-thumb-area">
							<ul>
								<li><img class="about-thumb1" src="{{asset('frontend/images/about/pic-1.jpg')}}" alt=""></li>
								<li><img class="about-thumb2" src="{{asset('frontend/images/about/pic-2.jpg')}}" alt=""></li>
								<li><img class="about-thumb3" src="{{asset('frontend/images/about/pic-3.jpg')}}" alt=""></li>
			...
			<img class="pt-img1 animate-wave" src="{{asset('frontend/images/shap/wave-orange.png')}}" alt="">
			<img class="pt-img2 animate2" src="{{asset('frontend/images/shap/circle-small-blue.png')}}" alt="">
			<img class="pt-img3 animate-rotate" src="{{asset('frontend/images/shap/line-circle-blue.png')}}" alt="">
			<img class="pt-img4 animate-wave" src="{{asset('frontend/images/shap/square-dots-orange.png')}}" alt="">
			<img class="pt-img5 animate2" src="{{asset('frontend/images/shap/square-blue.png')}}" alt="">
		</section>
		
		<!-- Our Progress -->
		<section class="section-area section-sp5 work-area" style="background-image: url(frontend/images/background/line-bg1.png); background-repeat: no-repeat; background-position: center; background-size: 100%;">
			...
			<img class="pt-img1 animate1" src="{{{asset('frontend/images/shap/circle-orange.png')}}}" alt="">
			<img class="pt-img2 animate2" src="{{{asset('frontend/images/shap/plus-orange.png')}}}" alt="">
			<img class="pt-img3 animate3" src="{{{asset('frontend/images/shap/circle-dots.png')}}}" alt="">
		</section>
			
		<!-- Appointment -->
		<section class="section-area account-wraper1">
			<div class="container-fluid">
				<div class="appointment-inner section-sp2" style="background-image: url(frontend/images/appointment/line-bg.png); background-repeat: no-repeat; background-position: 20px 140px;">
					<div class="container">
						<div class="row align-items-center">
							...
							<div class="col-xl-7 col-lg-6 col-md-6">
								<div class="appointment-thumb">
									<img src="{{asset('frontend/images/appointment/mobile.png')}}" alt="">
									<div class="images-group">
										<img class="img1" src="{{asset('frontend/images/appointment/women.png')}}" alt="">
										<img class="img2" src="{{asset('frontend/images/appointment/map-pin.png')}}" alt="">
										<img class="img3" src="{{asset('frontend/images/appointment/setting.png')}}" alt="">
										<img class="img4" src="{{asset('frontend/images/appointment/check.png')}}" alt="">
										<img class="img5" src="{{asset('frontend/images/appointment/chat.png')}}" alt="">
									</div>
								</div>
							</div>
						</div>					
					...
					<img class="pt-img1 animate1" src="{{asset('frontend/images/shap/trangle-orange.png')}}" alt="">
					<img class="pt-img2 animate-wave" src="{{asset('frontend/images/shap/wave-orange.png')}}" alt="">
					<img class="pt-img3 animate-wave" src="{{asset('frontend/images/shap/wave-blue.png')}}" alt="">
					<img class="pt-img4 animate2" src="{{asset('frontend/images/shap/circle-orange.png')}}" alt="">
				</div>					
			</div>
		</section>
		...
		<section class="section-area section-sp1 service-wraper">
			...
			<img class="pt-img1 animate-rotate" src="{{asset('frontend/images/shap/line-circle-blue.png')}}" alt="">
			<img class="pt-img2 animate2" src="{{asset('frontend/images/shap/square-dots-orange.png')}}" alt="">
			<img class="pt-img3 animate-wave" src="{{asset('frontend/images/shap/wave-blue.png')}}" alt="">
			<img class="pt-img4 animate1" src="{{asset('frontend/images/shap/square-rotate.png')}}" alt="">
		</section>
		...
		<section class="section-area section-sp3 testimonial-wraper">
				...
				<div class="row align-items-center">
					<div class="col-lg-6 text-center">
						<div class="thumb-wraper">
							<img class="bg-img" src="{{('frontend/images/testimonials/shape.png')}}" alt="">
							<ul>
								<li data-member="1"><a href="javascript:void(0);"><img src="{{asset('frontend/images/testimonials/pic1.jpg')}}" alt=""/></a></li>
								<li data-member="2"><a href="javascript:void(0);"><img src="{{asset('frontend/images/testimonials/pic2.jpg')}}" alt=""/></a></li>
								<li data-member="3"><a href="javascript:void(0);"><img src="{{asset('frontend/images/testimonials/pic3.jpg')}}" alt=""/></a></li>
								<li data-member="4"><a href="javascript:void(0);"><img src="{{asset('frontend/images/testimonials/pic4.jpg')}}" alt=""/></a></li>
								<li data-member="5"><a href="javascript:void(0);"><img src="{{asset('frontend/images/testimonials/pic5.jpg')}}" alt=""/></a></li>
								<li data-member="6"><a href="javascript:void(0);"><img src="{{asset('frontend/images/testimonials/pic6.jpg')}}" alt=""/></a></li>
							</ul>
						</div>
					</div>
					<div class="col-lg-6">
			...
			<img class="pt-img1 animate1" src="{{asset('frontend/images/shap/plus-orange.png')}}" alt="">
			<img class="pt-img2 animate2" src="{{asset('frontend/images/shap/square-blue.png')}}" alt="">
			<img class="pt-img3 animate3" src="{{asset('frontend/images/shap/circle-dots.png')}}" alt="">
			<img class="pt-img4 animate4" src="{{asset('frontend/images/shap/circle-orange-2.png')}}" alt="">
		</section>
